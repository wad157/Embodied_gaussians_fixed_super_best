#!/usr/bin/env python3
"""Frozen definitions for the EndoGaussian-on-SUPER baseline protocol."""
...
ADAPTER_VERSION = "endogaussian_super_v2_noninstrument_mask"
...
def normalized_time(frame: int, frame_count: int) -> float:
    """Match the official EndoGaussian loaders: image index divided by N."""
