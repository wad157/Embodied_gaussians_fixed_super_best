#!/usr/bin/env python3
"""Run PhysTwin's CMA plus differentiable spring-mass optimization on SUPER."""
...
def configure(args: argparse.Namespace, frame_count: int) -> int:
    ...
    cfg.reverse_z = False  # SUPER table/world uses +Z above its support plane.
    cfg.use_graph = True
...
def main() -> None:
    ...
    metadata = {
        "schema": "phystwin_super_physics_v1",
