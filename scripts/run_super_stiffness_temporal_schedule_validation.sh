...
OUTPUT_ROOT="${1:-${ROOT_DIR}/outputs/super_stiffness_dual_gradient_validation_20260826_v1}"
GROUND_TRUTH="${ROOT_DIR}/data/super/evaluation_v1/manual_tissue_tracks_10/ground_truth_2d3d_v1.npz"
FRAME_COUNT=900
FUTURE_VALIDATION_START=840
...
sha256sum \
    ...
    scripts/run_super_stiffness_temporal_schedule_validation.sh \
...
run_case() {
    ...
    CUDA_VISIBLE_DEVICES="${gpu_id}" \
        TORCH_EXTENSIONS_DIR="/Media_HDD/jwshan/tmp/torch_extensions_stiffness_schedule_gpu${gpu_id}" \
