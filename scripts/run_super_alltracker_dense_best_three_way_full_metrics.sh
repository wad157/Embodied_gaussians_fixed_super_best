...
OUTPUT_ROOT="${1:-${ROOT_DIR}/outputs/super_alltracker_triangle_d1_f2_three_way_full_metrics_20260829_v1}"
GROUND_TRUTH="${ROOT_DIR}/data/super/evaluation_v1/manual_tissue_tracks_10/ground_truth_2d3d_v1.npz"
BINDINGS="${BINDINGS:-${ROOT_DIR}/outputs/grasp5_alltracker_tissue_grid20_q3_triangle_d1_f2_20260829_v1/bindings.npz}"
OBSERVATIONS="${OBSERVATIONS:-${ROOT_DIR}/outputs/grasp5_alltracker_tissue_grid20_q3_triangle_observations_20260829_v1/observations.npz}"
...
sha256sum \
    ...
    scripts/run_super_alltracker_dense_best_three_way_full_metrics.sh \
...
run_case() {
    ...
    case "${method}" in
        ...
        pbd_alltracker_depth)
            ...
            method_args+=(--stiffness-evaluation-output "${result_dir}/diagnostics")
            ;;
        pbd_alltracker_depth_online_stiffness)
            ...
            method_args+=(
                ...
                --stiffness-evaluation-horizons 1
    ...
    CUDA_VISIBLE_DEVICES="${gpu_id}" \
        TORCH_EXTENSIONS_DIR="/Media_HDD/jwshan/tmp/torch_extensions_alltracker_dense_best_gpu${gpu_id}" \
