...
OUTPUT_ROOT="${1:-${ROOT_DIR}/outputs/super_alltracker_alternating_stiffness_full_20260829_v1}"
...
run_case 0 alternating_strain075 0.75 \
    > "${OUTPUT_ROOT}/alternating_strain075.log" 2>&1 &
pid_075=$!
run_case 1 alternating_strain100 1.00 \
    > "${OUTPUT_ROOT}/alternating_strain100.log" 2>&1 &
pid_100=$!
...
status_100=$?
set -e
printf 'alternating_strain075_status=%s\nalternating_strain100_status=%s\n' \
