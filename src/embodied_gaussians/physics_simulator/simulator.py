...
class PhysicsRolloutAuxiliaryState:
    ...
    paper_volume_stiffness: torch.Tensor | None
...
class Simulator:
    ...
    def clone_rollout_auxiliary_state(self) -> PhysicsRolloutAuxiliaryState:
        ...
        volume = (
            None
            if material is None
            else wp.to_torch(material.paper_volume_stiffness)
            .detach()
            .clone()
        )
    ...
    def restore_rollout_auxiliary_state(
        ...
        if material is None:
            if (
                ...
                or snapshot.paper_volume_stiffness is not None
            ...
            restore_optional(
                material.paper_volume_stiffness,
                snapshot.paper_volume_stiffness,
                "paper volume stiffness",
            )
            restore_optional(
