    ...
    def add_soft_body(
        ...
        if add_gaussians:
            ...
            if binding_mode == "surface_face_barycentric":
                ...
                # Surface deformation uses [edge_01, edge_02, unit_normal] as
                # its three-dimensional rest basis.  Mapping a unit normal
                # keeps Gaussian thickness fixed while the two tangent axes
                # follow the full triangle stretch and shear.
